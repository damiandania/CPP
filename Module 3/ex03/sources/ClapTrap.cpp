...
/*   Updated: 2024/03/20 13:22:58 by ddania-c         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(void) : _name("Unknow") , _hitPoints(CT_HIT_POINTS),
	_energyPoints(CT_ENERGY_POINTS), _attackDamage(CT_ATTACK_DAMAGE)
{
...
ClapTrap::ClapTrap(std::string name) : _name(name) , _hitPoints(CT_HIT_POINTS),
	_energyPoints(CT_ENERGY_POINTS), _attackDamage(CT_ATTACK_DAMAGE)
{
